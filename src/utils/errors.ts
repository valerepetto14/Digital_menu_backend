...
//Order
export const ORDER_NOT_FOUND = new errorResponse('Order not found', 404);
export const MISSING_ID = new errorResponse('Missing id', 400);
export const ORDER_ALREADY_PAID = new errorResponse('Order already paid', 400);
